...
export class Utils {
   ...
   */
  public static update(selected: Step, ind: number): void {
    ...
    if (subStepArr[prevSubstepInd]) {
      subStepArr[prevSubstepInd] = {...subStepArr[prevSubstepInd], status: Status.FINISHED};
    }
